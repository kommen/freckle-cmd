...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "PostInstall.txt", "README.rdoc", "Rakefile", "bin/freckle", "lib/freckle/cli.rb", "lib/freckle-gem.rb", "lib/freckle-gem/entry.rb", "script/console", "script/destroy", "script/generate", "test/test_=freckle_cli.rb", "test/test_freckle-gem.rb", "test/test_helper.rb"]
  s.has_rdoc = true
